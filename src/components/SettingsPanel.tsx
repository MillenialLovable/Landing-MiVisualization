...
export const SettingsPanel: React.FC<SettingsPanelProps> = ({
  ...
  const fontOptions = [
    ...
    { id: 'grotesk', name: 'Space Grotesk', fontFamily: 'Space Grotesk, sans-serif' },
  ...
  const handleColorChange = (colorScheme: any) => {
    ...
    document.documentElement.style.setProperty(colorScheme.cssVar, colorScheme.value);
  ...
  return (
    <div className="bg-transparent rounded-2xl p-6">
      <h2 className="text-xl font-semibold text-gray-900 mb-6">Configuración de Apariencia</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4 bg-white p-4 rounded-xl shadow-sm border border-gray-100">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Estilo Visual</h3>
          </div>
          <div className="space-y-2">
