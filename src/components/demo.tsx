...
const Demo = () => {
  ...
  const currentColor =
    colorSchemes.find((s) => s.id === selectedColor)?.value || "#3B82F6";
    ...
    switch (visualStyle) {
      case "modern":
        return (
          <svg
            ...
            className=" md:ml-[20px] lg:ml-[110px] xl:ml-[200px]"
          >
            <path
              d="M0 48C11.4244 47.5089 30.0617 45.2172 42.249 39.8369C46.1247 17.2157 65.83 0.000286102 89.5566 0L697.925 0C724.434 0 745.925 21.4903 745.925 48L0 48Z"
              fill={currentColor}
            />
            <path
              d="M733.719 27.3193C735.73 34.2131 749.4 48 787.999 48H733.719V27.3193Z"
              fill={currentColor}
            />
          </svg>
        );
      ...
      default: // 'classic'
        return (
          ...
          >
            <path
              d="M0 0C0.500661 6.22249 2.87122 16.4498 8.47949 22.9482C30.9448 26.9526 48 46.5859 48 70.2021V350.521C47.9996 377.031 26.5094 398.521 0 398.521V0Z"
              fill={currentColor}
            />
            <path
              d="M20.6807 392C13.787 393.074 6.97166e-05 400.378 0 421V392H20.6807Z"
              fill={currentColor}
            />
          </svg>
        );
  ...
  return (
    <div
      id="demo"
      className="hidden md:block max-w-7xl mx-auto p-6 space-y-6 font-lato"
    >
      {/* Dashboard Section */}
