  ...
  useSEO({
    ...
    description: post ? 
      typeof post.content === 'string' 
        ...
        : `Descubre ${post.title} en nuestro blog de Business Intelligence y análisis de datos.`
      : "El post solicitado no fue encontrado en nuestro blog de Business Intelligence.",
